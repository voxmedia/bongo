class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :collection_url, :feature_image_url, :background_url, :lede_image_url, :three_up_first_url, :three_up_last_url, :logo_url, :primary_color, :secondary_color)
    end
end
